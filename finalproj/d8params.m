...
% Class demonstration
% usage: d8params(paramNames,defaultParams)
% paramsNames: cell-array, each cell contains one parameter-name (character array)
% defaultParams: numeric row-array of default values for user input.
